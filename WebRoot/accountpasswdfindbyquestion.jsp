			...
			<div>
				...
				<div id="myTabContent" class="tab-content">
					...
					<div class="tab-pane fade in active" id="ligin-customer">
						<div class="well">
							<form method="post" class="form-signin" action="findbyQ">
							    <input type="hidden" name="usernumber" value="<s:property value="#session['infoCustomer'].usernumber"/>">
								<h2 class="form-signin-heading">请输入您的密保问题和答案</h2>
								密保问题<input type="text" name="passwdfind" class="input-block-level" placeholder="密保问题" />
								密保答案<input type="text" name="passwdanswer" class="input-block-level" placeholder="密保答案" />
